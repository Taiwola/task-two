...
describe('PersonService', () => {
  ...
  describe('remove operation', () => {
    describe('when create is called', () => {
      ...
      beforeEach(async () => {
        saveSpy = jest.spyOn(PersonModel.prototype, 'save');
        constructorSpy = jest.spyOn(PersonModel.prototype, 'constructorSpy');
        person = await service.remove(personStubs().name);
      });

      test('then it should be called with personModel', () => {
        expect(saveSpy).toHaveBeenCalled();
        expect(constructorSpy).toHaveBeenCalledWith(personStubs());
      });
  ...
  describe('create operation', () => {
    describe('when create is called', () => {
      ...
      beforeEach(async () => {
        saveSpy = jest.spyOn(PersonModel.prototype, 'save');
        constructorSpy = jest.spyOn(PersonModel.prototype, 'constructorSpy');
        person = await service.create(personStubs());
      });
